...
let soundTuples = [
    ...
    ['depressie', new Audio("soundboard/resources/sounds/depressie.mp3")],
    ['floerenAap', new Audio("soundboard/resources/sounds/floerenaap.mp3")],
    ['oejust', new Audio("soundboard/resources/sounds/oejust.mp3")]];
